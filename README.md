...
you can [set `sourcegraph` as your default remote](#settings).

**Note** that the remote can be named anything but its URL's host must match what's in associated link function's alist.
