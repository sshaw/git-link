...
(defcustom git-link-recognize-vc-names nil
  "Use the revision from the current buffer name if it is
recognized as one generated by vc when visiting a specific
revision of a file."
  :type 'boolean
  :group 'git-link)
...
(defun git-link-get-vc-revision ()
...
(defun git-link--commit ()
  (or
   (when git-link-recognize-vc-names
     (git-link-get-vc-revision))
